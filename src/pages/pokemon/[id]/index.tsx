      ...
      >
        <Grid xs={12}>
          <Box
            sx={{
              py: 1.2,
              boxShadow: " rgba(0, 0, 0, 0.24) 0px 0.4px 0.8px",
              display: "flex",
              justifyContent: "space-between",
            }}
          >
            <Typography sx={{ fontWeight: 500, fontSize: "22px", pl: 2 }}>
              {pokeman.name}
            </Typography>
            <Box>
              <IconButton
        ...
        <Grid item lg={6} md={6} xs={12}>
          ...
          <Box>
            ...
            {pokeman.abilities.map((data: any, i: any) => {
              return (
                <Chip
                  key={i}
                  sx={{
            ...
            {pokeman.types.map((data: any, i: any) => {
              return (
                <Chip
                  key={i}
                  sx={{
            ...
            >
              {pokeman.stats.map((data: any, i: any) => {
                return (
                  <Box key={i} sx={{ mx: 1 }}>
                    <Typography
                      sx={{
